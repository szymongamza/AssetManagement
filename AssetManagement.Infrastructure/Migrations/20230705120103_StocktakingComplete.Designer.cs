...
namespace AssetManagement.Infrastructure.Migrations
{
    ...
    [Migration("20230705120103_StocktakingComplete")]
    partial class StocktakingComplete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.AssetStocktakingComplete", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AssetStocktakingComplete");
                });
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.AssetStocktakingComplete", b =>
                {
                    b.HasOne("AssetManagement.Domain.Entities.Asset", "Asset")
                        .WithMany("AssetStocktakingsComplete")
                        .HasForeignKey("AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.Asset", b =>
                {
                    ...
                    b.Navigation("AssetStocktakingsComplete");
                });
